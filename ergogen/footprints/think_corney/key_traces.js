module.exports = {
    ...
    body: p => {
        ...
        const traces = `
            ...
            (segment (start ${ adjust_point(1.665959, 3.795306) }) (end ${ adjust_point(1.665959, 7) }) (width 0.25) (layer "F.Cu") (net 2))
            (via (at ${ adjust_point(1.665959, 7) }) (size 0.8) (drill 0.4) (layers "F.Cu" "B.Cu") (net 2))
            (segment (start ${ adjust_point(1.665959, 3.795306) }) (end ${ adjust_point(1.665959, 7.015306) }) (width 0.25) (layer "B.Cu") (net 2))
